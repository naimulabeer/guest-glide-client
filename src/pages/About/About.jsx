          ...
          <div className="container mx-auto py-8 flex flex-col lg:flex-row items-center justify-center">
            ...
            <div className="lg:w-1/2 lg:pl-12 px-2 mt-4 lg:mt-0">
              ...
              <p className="text-gray-600 mt-10">
                GuestGlide is your ultimate gateway to a beach paradise. Our
                website is designed to provide a seamless and immersive
                experience for travelers seeking the perfect coastal escape.
                Whether you are a sun-worshiper, an adventurer, or a relaxation
                enthusiast, GuestGlide has your dream beach vacation covered.
              </p>
          ...
          <div className="container mx-auto px-2 py-8 flex flex-col lg:flex-row items-center justify-center">
            <div className="lg:w-1/2 mt-4 lg:mt-0">
              ...
              <p className="text-gray-600">
                ...
                selection of beachfront accommodations, from luxurious
                oceanfront resorts to cozy seaside cottages. You can browse
                through stunning imagery and detailed descriptions to find the
                perfect retreat for your getaway. GuestGlide also goes the extra
                mile in helping you plan your beach vacation. We provide
                valuable travel guides, insider tips, and local recommendations,
                ensuring that you make the most of your beach paradise
                experience. Whether it is discovering hidden beaches, indulging
                in fresh seafood, or trying water sports, our website has it
                all.
              </p>
            </div>
